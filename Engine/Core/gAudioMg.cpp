...
int Sci = SE_LOAD("Content/Audio/M.ogg");
int bandit = SE_LOAD("Content/Audio/B.ogg");
SoundEffectsPlayer sound_effects_player_forSciFiSound;
SoundEffectsPlayer sound;
SoundEffectsPlayer ban;
...

{
	...
	sound_effects_player_forSciFiSound.Play(Sci);
	...
	ban.SetPosition(10000.0f, 1000.0f, 0.0f);
